                ...
                <div className="mt-8">
                    <div className="space-y-6">
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-neutral-200 rounded-lg shadow-sm bg-white text-sm font-medium text-neutral-700 hover:bg-neutral-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-neutral-900 transition duration-200"
                        >
                    ...
                    <div className="mt-6 text-center text-sm">
                        ...
                        <Link to="/auth/signUp" className="font-medium text-neutral-900 hover:text-neutral-700 underline underline-offset-2">
                            Sign up
                        </Link>
                    </div>
                </div>
